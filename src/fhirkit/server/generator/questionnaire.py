    ...
    QUESTIONNAIRE_TEMPLATES: list[dict[str, Any]] = [
        ...
        },
        {
            ...
            "items": [
                ...
                {"linkId": "transportation", "text": "Do you have trouble getting transportation to medical appointments?", "type": "boolean"},
                {"linkId": "utilities", "text": "In the past year, have you had utilities shut off?", "type": "boolean"},
                {"linkId": "safety", "text": "Do you feel physically or emotionally unsafe where you live?", "type": "boolean"},
            ],
            "answer_options": [
        ...
        },
        {
            ...
            "items": [
                ...
                {"linkId": "2", "text": "Over the past 2 weeks, were there days you didn't take your medicine?", "type": "boolean"},
                {"linkId": "3", "text": "Have you ever stopped taking medicine without telling your doctor because you felt worse?", "type": "boolean"},
                {"linkId": "4", "text": "When you travel or leave home, do you sometimes forget to bring your medicine?", "type": "boolean"},
                {"linkId": "5", "text": "Did you take your medicine yesterday?", "type": "boolean"},
                {"linkId": "6", "text": "When you feel your symptoms are under control, do you sometimes stop taking medicine?", "type": "boolean"},
                {"linkId": "7", "text": "Do you ever feel hassled about sticking to your treatment plan?", "type": "boolean"},
                {"linkId": "8", "text": "How often do you have difficulty remembering to take all your medications?", "type": "choice"},
            ],
            "answer_options": [
        ...
        },
        {
            ...
            "items": [
                ...
                {"linkId": "recall-words", "text": "I will say 3 words. Repeat them: Apple, Table, Penny", "type": "display"},
                ...
                {"linkId": "recall-delayed", "text": "What were the 3 words I asked you to remember?", "type": "string"},
        ...
        },
        {
            ...
            "items": [
                ...
                {"linkId": "bleeding", "text": "Do you have a bleeding disorder or take blood thinners?", "type": "boolean"},
                ...
                {"linkId": "ride-home", "text": "Do you have someone to drive you home after surgery?", "type": "boolean"},
            ],
            "answer_options": None,
        },
    ]
